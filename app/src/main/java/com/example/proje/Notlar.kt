...
class Notlar :AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    class MyAdapter(private val context: Context, private val arrayList: java.util.ArrayList<MyData>) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.notlar_item, parent, false)
